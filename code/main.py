...
def main():
    ...
    for epoch in range(1):
        ...
        if f1 > max_f1:
            ...
            torch.save(state, os.path.join("../checkpoints1", "bert_best.pt"))
            state = {"model_view": model_view.state_dict()}
            torch.save(state, os.path.join("../checkpoints1", "model_view.pt"))
            ...
            for rowid, row in tqdm(df_review_test.iterrows()):
                ...
                with open("../output/pred_0416.csv", "w",encoding='utf-8') as f:
                    for line in lines:
                        f.write(line + "\n")
